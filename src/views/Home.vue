<template>
  <v-card class="home-container">
    <v-card-text>
      ...
      <v-card class="mb-1" nav :to="'FindPeopleHome'">
        <v-card-subtitle>
      ...
      <v-card class="mb-1" nav :to="'CourtList'">
        <v-card-subtitle>
      ...
      <v-card class="mb-1" nav :to="'Mypage'">
        <v-card-subtitle>
          <v-icon class="mr-3">mdi-map-search-outline</v-icon>
          <span>마이페이지</span>
        </v-card-subtitle>
